...
export function AddNewsCard({ onCancel, onSave }: Props) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setApiError(err instanceof Error ? err.message : 'Đã xảy ra lỗi khi tạo tin tức');
      notifications.show({
        title: 'Lỗi',
  ...
  return (
    <div className={classes.page} style={{ position: 'relative' }}>
      ...
      <div className={classes.pageHeader}>
        <h1 className={classes.pageTitle}>Thêm Tin Tức Mới</h1>
        <p className={classes.pageSubtitle}>Nhập thông tin chi tiết để tạo tin tức mới trong hệ thống.</p>
      </div>
